...
from .save_and_load import get_tira_diagonal_model_state_dict, set_tira_diagonal_model_state_dict


class TiraDiagonalPeftModel(PeftModel):
    def __init__(self, model, peft_config: TiraDiagonalConfig, adapter_name="default"):
        ...
        self.base_model = TiraDiagonalModel(self.base_model, self.peft_config, adapter_name)
    ...
    def save_pretrained(self, save_directory, **kwargs):
        ...
        for adapter_name, peft_config in self.peft_config.items():
            output_state_dict = get_tira_diagonal_model_state_dict(
    ...
    def from_pretrained(cls, model, model_id, adapter_name="default", is_trainable=False, **kwargs):
        config = TiraDiagonalConfig.from_pretrained(model_id, subfolder=kwargs.get("subfolder", None))
    ...
    def load_adapter(self, model_id, adapter_name, is_trainable=False, **kwargs):
        ...
        set_tira_diagonal_model_state_dict(self, adapters_weights, adapter_name=adapter_name)
        self.eval()
...
class TiraDiagonalPeftModelForCausalLM(TiraDiagonalPeftModel):
    def __init__(self, model, peft_config: TiraDiagonalConfig, adapter_name="default"):
