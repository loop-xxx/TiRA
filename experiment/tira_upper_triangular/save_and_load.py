def get_tira_upper_triangular_model_state_dict(model, state_dict=None, adapter_name="default"):
...
def set_tira_upper_triangular_model_state_dict(model, peft_model_state_dict, adapter_name="default"):
